...
struct CreateTaskRequest: ChatworkApiRequest {
    ...
    init(roomId: Chatwork.RoomId, text: String, assigneeIds: [Int], limitType: LimitType = .none, deadline: Int? = nil) {
        self.roomId = roomId
        self.text = text
    ...
    init(roomId: Chatwork.RoomId, text: String, assigneeIds: [Int], limitType: LimitType = .none, deadline: Date) {
